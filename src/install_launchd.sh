...
# Install/refresh both LaunchAgents on the same machine.
# (Current setup: both on the personal Mac that has iCloud access to the audio sources.)
#
# This is the primary/only command you need.
...
python3 - "$SIMPLE_TEMPLATE_PATH" "$VOICE_TEMPLATE_PATH" <<'PY'

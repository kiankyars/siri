...
# Install/refresh ONLY the com.siri.simple LaunchAgent.
# This watches the Obsidian "simple" endpoint directories (notes, course, jl)
# and runs src/run_simple_ingest.sh on changes.
...
: "${VOICE_MEMOS_DIR_0:?Set VOICE_MEMOS_DIR_0 in .env (used to locate simple endpoint dirs)}"
: "${VOICE_MEMOS_DIR_1:?Set VOICE_MEMOS_DIR_1 in .env (used to locate simple endpoint dirs)}"
